...
server <- function(input, output) {
  ...
  output$downloadData1 <- downloadHandler(
    ...
    content = function(file) {
      write.csv(values$basis, file, row.names = FALSE)
    }
  )
  ...
  output$downloadData2 <- downloadHandler(
    ...
    content = function(file) {
      write.csv(values$family, file, row.names = FALSE)
    }
  )
  ...
  output$downloadData3 <- downloadHandler(
    ...
    content = function(file) {
      write.csv(values$genus, file, row.names = FALSE)
    }
  )
  ...
  output$downloadData4 <- downloadHandler(
    ...
    content = function(file) {
      write.csv(values$species, file, row.names = FALSE)
    }
  )
  ...
  output$downloadData5 <- downloadHandler(
    ...
    content = function(file) {
      write.csv(values$feeding, file, row.names = FALSE)
    }
  )
  ...
  output$downloadData6 <- downloadHandler(
    ...
    content = function(file) {
      write.csv(values$structure, file, row.names = FALSE)
    }
  )
  ...
  output$downloadData7 <- downloadHandler(
    ...
    content = function(file) {
      write.csv(values$df_function, file, row.names = FALSE)
    }
  )
}
